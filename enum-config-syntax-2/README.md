...
- `dec.tmLanguage.json` → `syntaxes/` 目录

### 3. 安装扩展

**Windows:**
```bash
xcopy /E /I dec-syntax "%USERPROFILE%\.vscode\extensions\dec-syntax"
```

**macOS/Linux:**
```bash
cp -r dec-syntax ~/.vscode/extensions/
```
...
```json
{
  "editor.tokenColorCustomizations": {
    "textMateRules": [
      {
        "scope": "comment.line.number-sign.dec",
        "settings": {
          "foreground": "#6A9955",
          "fontStyle": "italic"
        }
      ...
      {
        "scope": "entity.name.type.table.dec",
        "settings": {
          "foreground": "#4EC9B0",
          "fontStyle": "bold"
        }
      ...
      {
        "scope": "keyword.operator.separator.update.dec",
        "settings": {
          "foreground": "#C586C0",
          "fontStyle": "bold"
        }
      ...
      {
        "scope": "keyword.operator.logical.dec",
        "settings": {
          "foreground": "#C586C0",
          "fontStyle": "bold"
        }
      ...
      {
        "scope": "variable.other.field.dec",
        "settings": {
          "foreground": "#9CDCFE"
        }
      },
      {
        "scope": "variable.other.field.quoted.dec",
        "settings": {
          "foreground": "#9CDCFE",
          "fontStyle": "italic"
        }
      ...
      {
        "scope": "storage.type.field-type.dec",
        "settings": {
          "foreground": "#4EC9B0"
        }
      },
      {
        "scope": "variable.other.field-name.dec",
        "settings": {
          "foreground": "#9CDCFE"
        }
      },
      {
        "scope": "string.quoted.single.dec, string.quoted.double.dec",
        "settings": {
          "foreground": "#CE9178"
        }
      },
...
生成 `dec-syntax-0.0.1.vsix` 文件，可通过：
